...
| **Datos de Contacto** | Correos institucionales (`@investigaciones.cl`), correos particulares (`@gmail.com`, `@duocuc.cl`), teléfonos de contacto. | **Crítico** | Prohibido exponer en GitHub o archivos versionados. En configuración de prueba usar dominios de ejemplo (`usuario@ejemplo.com`). |
