...
def main():
    ...
    class_rows = [
        ...
        ["Datos de Contacto", "Correos electrónicos institucionales (@investigaciones.cl), correos particulares, teléfonos móviles.", "Crítico", "Exclusión estricta de repositorios remotos. En plantillas emplear dominios de ejemplo ('usuario@ejemplo.com')."],
