...
<head>
<meta charset="UTF-8">
<title>Manual de Usuario — Sistema de Gestión de Turnos</title>
<style>
  @page {{
  ...
  *, *:before, *:after {{
  ...
  .btn-accent {{ background-color: #0f766e; color: #ffffff; }}
  .btn-card2 {{ background-color: #252d34; border: 1px solid #475569; color: #f1f5f3; }}
    ...
    <div>
      <div class="mock-card">
        <div style="display: flex; justify-content: space-between;">
          <strong style="color: #8de1d2; font-size: 8.5pt;">📅 Semana 1 (05/10 al 11/10)</strong>
          <span style="background: #0f766e; color: #fff; font-size: 7pt; padding: 2px 6px; border-radius: 4px;">AUTOMÁTICO</span>
        </div>
        <div style="margin-top: 4px; font-weight: bold; color: #6ee7b7;">Le toca a: PRO PEREZ JUAN</div>
        <div style="text-align: right; margin-top: 4px;">
          <span class="btn-sample btn-change" style="font-size: 7.5pt;">✏️ Cambiar</span>
        </div>
      </div>
      <div class="mock-card">
        <div style="display: flex; justify-content: space-between;">
...
<div class="note-box note-tip">
  ...
  <em>Ejemplo: "📌 Cambio manual de guardia: JUAN PEREZ (Día 12) — Motivo: Accidente en trayecto".</em>
</div>
...
<ul>
  <li><strong>＋ Añadir Persona:</strong> Pulsa el botón verde arriba a la derecha. Escribes el nombre completo (ej: <code>JUAN PEREZ</code>) y su correo electrónico.</li>
